...
;(function(_){
  ...
  function Slider( opt ){
    ...
    // //切换按钮
    // this.mslider = [].slice.call(this.slider.querySelectorAll('.m-slider'))[0];
    // this.prev = [].slice.call(this.mslider.querySelectorAll('.cursor-pre'));
    // this.next = [].slice.call(this.mslider.querySelectorAll('.cursor-next'));    
  ...
  _.extend( Slider.prototype, {
    ...
    _onNav: function(pageIndex, slideIndex){
      ...
      for(var i =-1; i<= 1; i++){
        ...
        img.src = './images/banner' + ( this._normIndex(pageIndex + i, this.pageNum)+1 ) + '.png';
      }
